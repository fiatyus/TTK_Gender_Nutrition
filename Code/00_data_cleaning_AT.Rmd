...
# here-i-am
here::i_am("06_Code/Data_Cleaning.rmd")

tkd_raw <- read_excel(here::here("03_CARE data files/01_Takunda/PaBS Datasets/Takunda PaBS Data 2024.xlsx"))

ttk_raw <- read_sav(here::here("03_CARE data files/02_Titukulane/TTK PaBS 2024 Datasets/data2024version1.sav"))
...
TKD_names <- read_excel(here::here("06_Code/Mapping_Variables/TKD_Var_Names_AT.xlsx"))
...
TTK_names <- read_excel(here::here("06_Code/Mapping_Variables/TTK_Var_Names_AT.xlsx"))
...
```{r}
# exporting the merged data sets to the data files folder
write_csv(data4analysis, file = here::here("07_Afia/transform_data_AT.csv"))
```
